        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                            ...
                            <form wire:submit.prevent="store">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div
                                        ...
                                        <input type="file" wire:model="imagen" id="imagen" class="hidden" wire:key="imagen-upload-{{ rand() }}">
                                            ...
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                @else
                                                    <p class="mt-2 text-sm text-gray-600">
                                                        <span class="font-medium text-blue-600 hover:text-blue-800">Selecciona una imagen</span>
                                    ...
                                    @if ($imagen)
                                        <div class="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                                            <p class="text-sm text-blue-600 mb-2 font-medium">Vista previa:</p>
                                            <div
                                                class="relative overflow-hidden rounded-lg h-48 bg-white flex items-center justify-center">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
                                ...
                                <div class="gallery-overlay">
                                    <div class="p-3 w-full flex justify-between items-center">
                                        ...
                                        <div class="flex space-x-1">
                                            ...
                                            <button wire:click="delete({{ $image->id }})" onclick="return confirm('¿Estás seguro de eliminar esta imagen?')" class="gallery-action-btn delete-btn">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @empty
                        <div
                            class="col-span-full py-12 flex flex-col items-center justify-center bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
